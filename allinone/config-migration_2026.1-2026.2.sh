...
# from version 2026.1 to version 2026.2

set -e

# Default URL of the installation script on GitHub
GITHUB_URL="https://github.com/mycesys/hypha-installation/archive/refs/heads/2026.2.zip"

NEW_VERSION_SOURCES=2026.2_"$(date '+%s')"
...
show_help() {
  ...
  echo
  echo "This script migrates from version 2026.1 to 2026.2."
  ...
  echo "  --archive=path/to/archive  Path to the local archive contains 2026.2 installation scripts."
  ...
  echo "  $0 --archive=2026.2.zip                     # Uses provided zip file for migration"
  echo "  $0 --env=config/.env                             # Specifies path to .env file"
  echo "  $0 --archive=2026.2.zip --env=config/.env   # Specifies path to .env file"
}
...
cp "$UNZIP_DIR"/hypha-installation-2026.2/allinone/prepare-dirs.sh ./
cp "$UNZIP_DIR"/hypha-installation-2026.2/allinone/create_databasebackup.sh ./
cp "$UNZIP_DIR"/hypha-installation-2026.2/allinone/restore_database.sh ./
...
for i in guacamole 3d-service hub-auth hub-ui hypha-backend-dictionary hypha-bff hypha-core hypha-dashboard hypha-files hypha-gateway hypha-resources hypha-tags hypha-tasks hypha-ui hypha-workflow; do
  \cp -rf "$UNZIP_DIR"/hypha-installation-2026.2/$i/. ../$i
done
cp -f "$UNZIP_DIR"/hypha-installation-2026.2/allinone/dotkey ./
chmod +x dotkey

cp "$UNZIP_DIR"/hypha-installation-2026.2/allinone/docker-compose.yml ./
cp "$UNZIP_DIR"/hypha-installation-2026.2/allinone/licenses/*.default ./licenses/
cp -r "$UNZIP_DIR"/hypha-installation-2026.2/allinone/vault_config ./
cp "$UNZIP_DIR"/hypha-installation-2026.2/allinone/nginx.guacamole.conf ./

#### Creating a backup for existing .env file

backupenvfile="${env_file}".2026.1-"$(date '+%s')".backup
...
printf '\n'
echo "HYPHA_CORE_VERSION=2026.2.4"
echo "HYPHA_FILES_VERSION=2026.2.3"
echo "HYPHA_GATEWAY_VERSION=2026.2.3"
echo "HYPHA_BFF_VERSION=2026.2.11"
echo "HYPHA_WORKFLOW_VERSION=2026.2.9"
echo "HYPHA_RESOURCES_VERSION=2026.2.6"
echo "HYPHA_TASKS_VERSION=2026.2.15"
echo "HYPHA_TAGS_VERSION=2026.2.1"
echo "HYPHA_DASHBOARD_VERSION=2026.2.1"
echo "HYPHA_UI_VERSION=2026.2.43"
echo "HUB_AUTH_VERSION=2026.2.6"
echo "HUB_UI_VERSION=2026.2.43"
echo "HYPHA_BACKEND_DICTIONARY_VERSION=2026.2.8"
echo "HYPHA_3D_DOTKEY_SERVICE_VERSION=2026.1"
echo "HYPHA_3D_FREECAD_SERVICE_VERSION=2026.01"
echo "HYPHA_3D_SERVICE_VERSION=2026.01"
printf '\n'
...
echo "HYPHA_COMMON_CIPHER_KEY=$HYPHA_COMMON_CIPHER_KEY"
...
echo "HYPHA_TAGS_DB_USERNAME=$HYPHA_TAGS_DB_USERNAME"
echo "HYPHA_TAGS_DB_PASSWORD=$HYPHA_TAGS_DB_PASSWORD"
echo "HYPHA_GUACAMOLE_DB_USERNAME=guacd"
echo "HYPHA_GUACAMOLE_DB_PASSWORD=guacd"
echo "HYPHA_GUACAMOLE_ADMIN_PASSWORD=816624e8e535bd4c5b"
printf '\n'
...
echo "HYPHA_3D_DOTKEY_SERVICE_URL=3d-service-dotkey:8080"
...
HYPHA_3D_SERVICE_VERSION
HYPHA_3D_FREECAD_SERVICE_VERSION
HYPHA_3D_DOTKEY_SERVICE_VERSION
...
HYPHA_TAGS_DB_USERNAME
HYPHA_TAGS_DB_PASSWORD
HYPHA_GUACAMOLE_DB_USERNAME
HYPHA_GUACAMOLE_DB_PASSWORD
HYPHA_GUACAMOLE_ADMIN_PASSWORD
DISCOVERY_PREFER_IP
