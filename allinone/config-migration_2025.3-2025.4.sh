...
# from version 2025.3 to version 2025.4
...
show_help() {
  ...
  echo
  echo "This script migrates from version 2025.3 to 2025.4."
  ...
  echo "  --archive=path/to/archive  Path to the local archive contains 2025.4 installation scripts."
  ...
  echo "  $0 --archive=2025.4.zip                     # Uses provided zip file for migration"
  echo "  $0 --env=config/.env                             # Specifies path to .env file"
  echo "  $0 --archive=2025.4.zip --env=config/.env   # Specifies path to .env file"
}
...
printf '\n'
echo "HYPHA_CORE_VERSION=2025.4.7"
echo "HYPHA_FILES_VERSION=2025.4.8"
echo "HYPHA_GATEWAY_VERSION=2025.4.3"
echo "HYPHA_BFF_VERSION=2025.4.15"
echo "HYPHA_WORKFLOW_VERSION=2025.4.12"
echo "HYPHA_RESOURCES_VERSION=2025.4.13"
echo "HYPHA_TASKS_VERSION=2025.4.8"
echo "HYPHA_TAGS_VERSION=2025.4.4"
echo "HYPHA_DASHBOARD_VERSION=2025.4.4"
echo "HYPHA_UI_VERSION=2025.4.55"
echo "HUB_AUTH_VERSION=2025.4.4"
echo "HUB_UI_VERSION=2025.4.55"
echo "HYPHA_BACKEND_DICTIONARY_VERSION=2025.4.17"
echo "HYPHA_3D_SERVICE_VERSION=2025.1"
echo "HYPHA_3D_FREECAD_VERSION=2025.1"
printf '\n'
